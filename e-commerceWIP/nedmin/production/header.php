...
$say=$kullanicisor->rowCount();//yabancı giriş engelleme için 1
$kullanicicek=$kullanicisor -> fetch(PDO::FETCH_ASSOC);


//yabancı giriş engelleme için 2
if ($say==0) {
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>Admin Menü</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="hakkimizda.php"><i class="fa fa-info"></i> Hakkınızda </a></li>
