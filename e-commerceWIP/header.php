    			...
    			<div class="container">
    				<div class="row">
    					<div class="col-xs-6 col-md-4 main-logo">
    						<a href="index.php"><img width="200" src="<?php echo $ayarcek['ayar_logo']; ?>" alt="Site Logosu" class="logo img-responsive"></a>
    					</div>
    								...
    								<div class="regwrap">
    									<div class="row">
    										...
    										<div class="col-md-6">
    											...
    											<p>
    												Yeni bir kullanıcısın? Alışverişe başlamak için lütfen kaydol...
    											</p>
